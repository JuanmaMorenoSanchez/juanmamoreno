...
// Slimmed snapshot of the nfts-snapshot endpoint: only the fields the app
// actually reads (tokenId, name, image urls, metadata attributes are kept).
// Loaded via dynamic import so it stays out of the main bundle.
