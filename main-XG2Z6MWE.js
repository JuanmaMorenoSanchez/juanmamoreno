...
`],encapsulation:2})}return n})();var Ja$1=(()=>{class n{isErrorState(t,i){return!!(t&&t.invalid&&(t.touched||i&&i.submitted))}isSignalErrorState(t){if(!t)return!1;let i=t().invalid(),r=t().touched();return i&&r}static ɵfac=function(i){return new(i||n)};static ɵprov=Kr$1({token:n,factory:n.ɵfac})}return n})();var ur=class{_defaultMatcher;_parentFormGroup;_parentForm;_stateChanges;errorState=!1;matcher;ngControl;formField;constructor(e,t,i,r,o){this._defaultMatcher=e,this._parentFormGroup=i,this._parentForm=r,this._stateChanges=o,t?Ar$1(t.field)&&!t.updateValueAndValidity?(this.formField=t,this.ngControl=null):(this.formField=null,this.ngControl=t):this.ngControl=this.formField=null}updateErrorState(){let e=this.errorState,t=this._getCurrentErrorState(this.matcher||this._defaultMatcher);t!==e&&(this.errorState=t,this._stateChanges.next())}_getCurrentErrorState(e){if(this.formField&&e?.isSignalErrorState)return e.isSignalErrorState(this.formField.field())??!1;let t=this._parentFormGroup||this._parentForm,i=this.ngControl?this.ngControl.control:null;return e?.isErrorState(i,t)??!1}};var c$1=(()=>{class t{constructor(){this.visible=ze$1(!1)}static{this.ɵfac=function(o){return new(o||t)}}static{this.ɵprov=de$2({token:t,factory:t.ɵfac,providedIn:`root`})}}return t})();var c=(function(r){return r.ASC=`asc`,r.DESC=`desc`,r})(c||{});var n$1=new S$2(`ARTWORK_PORT`);var n=(function(e){return e.SPANISH=`es-ES`,e.ENGLISH=`en-EN`,e})(n||{});var h=[`studio`,`door`];function p(e){let f=e.split(`?`)[0].split(`#`)[0].replace(/^\/+/,``).split(`/`)[0];return h.includes(f)}var d=`juanmamoreno.language`;function S(e){try{window.localStorage.setItem(d,e)}catch{}}function L(){try{let e=window.localStorage.getItem(d);return Object.values(n).includes(e)?e:null}catch{return null}}function N(){if(typeof window>`u`)return n.ENGLISH;let e=window.navigator.language||window.navigator.languages?.[0]||n.ENGLISH;return Object.values(n).includes(e)?e:n.ENGLISH}var G=(()=>{class e{constructor(){this.router=y$3(ee),this.url=P$3(this.router.events.pipe(bn$3(t=>t instanceof j$1),Ve$3(()=>this.router.url)),{initialValue:this.router.url}),this.carriesLanguage=_t$5(()=>!p(this.url())),this.inSpanish=_t$5(()=>{let t=this.url().split(`?`)[0].split(`#`)[0];return t===`/es`||t.startsWith(`/es/`)}),this.contentLanguage=_t$5(()=>this.inSpanish()?`es`:`en`)}link(t=``){let o=t.replace(/^\/+|\/+$/g,``);return`${this.inSpanish()?`/es`:``}/${o}`.replace(/\/+$/,``)||`/`}static{this.ɵfac=function(o){return new(o||e)}}static{this.ɵprov=de$2({token:e,factory:e.ɵfac,providedIn:`root`})}}return e})();var ht={type:null,entityIds:null,skip:!1,payload:null};var Qi=!1;function Gi(){Qi=!1}function me(n,i,e){Y(n,i,e),Qi=!0}function Y(n,i,e){Qi===!1&&(ht.type=n,ht.entityIds=i,ht.payload=e)}function $i(n=!0){ht.skip=n}function Wi(n,i){return function(e,t,r){let a=r.value;return r.value=function(...o){return me(n,i),a.apply(this,o)},r}}function Me(n,i){return n.hasOwnProperty(i)}function fe(n){return Array.isArray(n)}function zt(n){return n.hasOwnProperty(`active`)}function hi(n){return fe(n)}function Ut({active:n,ids:i,entities:e}){return hi(n)?ba(n,i):Me(e,n)===!1?null:n}function ba(n,i){let e=n.filter(t=>i.indexOf(t)>-1);return e.length===n.length?n:e}function Ki({state:n,entities:i,idKey:e,options:t={},preAddEntity:r}){let a={},o=[],l=!1;for(let u of i)if(Me(n.entities,u[e])===!1){let f=r(u),q=f[e];a[q]=f,t.prepend?o.unshift(q):o.push(q),l=!0}return l?{newState:s$2(r$1({},n),{entities:r$1(r$1({},n.entities),a),ids:t.prepend?[...o,...n.ids]:[...n.ids,...o]}),newIds:o}:null}function Z(n){return n==null}function Q(n){return Z(n)?[]:Array.isArray(n)?n:[n]}function Te(n){return fe(n)?n.length===0:!1}function w(n){return typeof n==`function`}function Ie(n){let i=typeof n;return n!=null&&(i==`object`||i==`function`)}var ya={resettable:!1,ttl:null,producerFn:void 0};function Mt(){return ya}function va(){return ya.producerFn}function nt(n){return Z(n)===!1}var jt=new ne$2;var ut=new or$2(50,5e3);var Yi=new ne$2;function xa(n){jt.next(n)}function wa(n){ut.next(n)}function ka(n,i){Yi.next({storeName:n,action:i})}var ft=typeof window<`u`;var Ht=!ft;var Zi=()=>{try{return typeof localStorage<`u`}catch{return!1}};var Sa=()=>{try{return typeof sessionStorage<`u`}catch{return!1}};var F={};var Xi={};ft&&(window.$$stores=F,window.$$queries=Xi);function Ji(n){return n&&n.charAt(0).toUpperCase()+n.slice(1)}var Tt=[];function en(n,i={}){if(Ht||!window.__REDUX_DEVTOOLS_EXTENSION__)return;Tt.length&&Tt.forEach(f=>{f.unsubscribe?f.unsubscribe():f&&f()}),n&&n.run||(n=n||{},n.run=f=>f(),i=n);let r=Object.assign({},{name:`Akita`,shallow:!0,storesWhitelist:[]},i),a=r.storesWhitelist,o=window.__REDUX_DEVTOOLS_EXTENSION__.connect(r),l={},u=f=>a.length?a.indexOf(f)>-1:!0;Tt.push(ut.subscribe(f=>{u(f)!==!1&&(l=s$2(r$1({},l),{[f]:F[f]._value()}),o.send({type:`[${Ji(f)}] - @@INIT`},l))})),Tt.push(jt.subscribe(f=>{u(f)!==!1&&(delete l[f],o.send({type:`[${f}] - Delete Store`},l))})),Tt.push(Yi.subscribe(({storeName:f,action:q})=>{if(u(f)===!1)return;let Lt=q,{type:P,entityIds:A,skip:C}=Lt,te=u$4(Lt,[`type`,`entityIds`,`skip`]).payload;if(C){$i(!1);return}let he=F[f];if(!he||i.shallow===!1&&l[f]&&JSON.stringify(he._value())===JSON.stringify(l[f]))return;l=s$2(r$1({},l),{[f]:he._value()});let ge=Ji(f),ie=nt(A)?`[${ge}] - ${P} (ids: ${A})`:`[${ge}] - ${P}`;if(i.logTrace&&(console.group(ie),console.trace(),console.groupEnd()),i.sortAlphabetically){let xt=Object.keys(l).sort().reduce((wt,Ft)=>(wt[Ft]=l[Ft],wt),{});o.send(r$1({type:ie},te),xt);return}o.send(r$1({type:ie},te),l)})),Tt.push(o.subscribe(f=>{if(f.type===`DISPATCH`){if(f.payload.type===`COMMIT`){o.init(l);return}if(f.state){let P=JSON.parse(f.state);for(let A=0,C=Object.keys(P);A<C.length;A++){let B=C[A];F[B]&&n.run(()=>{F[B]._setState(()=>P[B],!1)})}}}}))}var rt=(function(n){return n.Set=`Set`,n.Add=`Add`,n.Update=`Update`,n.Remove=`Remove`,n})(rt||{});var qt=!0;function tn(){qt=!1,ft&&(delete window.$$stores,delete window.$$queries)}function R(){return qt}function nn(n,i,e){let t;if(fe(n))t=n;else if(Ie(n)){if(Z(e))return;n=Object.assign({wrap:!0},n);let r=i.indexOf(e);if(n.prev){let a=r===0;if(a&&!n.wrap)return;t=a?i[i.length-1]:i[r-1]}else if(n.next){let a=i.length===r+1;if(a&&!n.wrap)return;t=a?i[0]:i[r+1]}}else{if(n===e)return;t=n}return t}var rn=()=>({entities:{},ids:[],loading:!0,error:null});function Se(n){return n===void 0}function an({state:n,ids:i}){if(Z(i))return Ca(n);let e=n.entities,t={};for(let a of n.ids)i.includes(a)===!1&&(t[a]=e[a]);let r=s$2(r$1({},n),{entities:t,ids:n.ids.filter(a=>i.includes(a)===!1)});return zt(n)&&(r.active=Ut(r)),r}function Ca(n){return s$2(r$1({},n),{entities:{},ids:[],active:hi(n.active)?[]:null})}function on(n,i,e){let t={entities:{},ids:[]};for(let r of n){let a=e(r);t.entities[a[i]]=a,t.ids.push(a[i])}return t}function Ea(n){return n.entities&&n.ids}function Na(n,i){let e={};for(let t of Object.keys(n))e[t]=i(n[t]);return e}function sn({state:n,entities:i,idKey:e,preAddEntity:t,isNativePreAdd:r}){let a,o;if(fe(i)){let u=on(i,e,t);a=u.entities,o=u.ids}else Ea(i)?(a=r?i.entities:Na(i.entities,t),o=i.ids):(a=r?i:Na(i,t),o=Object.keys(a).map(u=>isNaN(u)?u:Number(u)));let l=s$2(r$1({},n),{entities:a,ids:o,loading:!1});return zt(n)&&(l.active=Ut(l)),l}function ln(n){Object.freeze(n);let i=typeof n==`function`,e=Object.prototype.hasOwnProperty;return Object.getOwnPropertyNames(n).forEach(function(t){e.call(n,t)&&(!i||t!==`caller`&&t!==`callee`&&t!==`arguments`)&&n[t]!==null&&(typeof n[t]==`object`||typeof n[t]==`function`)&&!Object.isFrozen(n[t])&&ln(n[t])}),n}function Aa(n,i){n||console.error(`@StoreConfig({ name }) is missing in ${i}`)}function qe(n){return n!=null&&`${n}`!=`false`}function It(n){return qe(n)&&n.constructor.name===`Object`}var gt=`akitaConfig`;function cn(n){return function(i){i[gt]={idKey:`id`};for(let e=0,t=Object.keys(n);e<t.length;e++){let r=t[e];r===`name`?i[gt].storeName=n[r]:i[gt][r]=n[r]}}}var bo=new ne$2;var Ma=new nr$2(!1);var Qe={activeTransactions:0,batchTransaction:null};function Ta(){pi()||(Qe.batchTransaction=new ne$2),Qe.activeTransactions++,Ma.next(!0)}function Ia(){--Qe.activeTransactions===0&&(Qe.batchTransaction.next(!0),Qe.batchTransaction.complete(),Ma.next(!1),bo.next(!0))}function pi(){return Qe.activeTransactions>0}function dn(){return Qe.batchTransaction?Qe.batchTransaction.asObservable():hy(!0)}function Qt(n,i=void 0){Ta();try{return n.apply(i)}finally{me(`@Transaction`),Ia()}}function ui(){return function(n,i,e){let t=e.value;return e.value=function(...r){return Qt(()=>t.apply(this,r),this)},e}}var at=class{constructor(i,e={}){this.options=e,this.inTransaction=!1,this.cache={active:new nr$2(!1),ttl:null},this.onInit(i)}setLoading(i=!1){i!==this._value().loading&&(R()&&Y(`Set Loading`),this._setState(e=>s$2(r$1({},e),{loading:i})))}setHasCache(i,e={restartTTL:!1}){if(i!==this.cache.active.value&&this.cache.active.next(i),e.restartTTL){let t=this.getCacheTTL();t&&(this.cache.ttl!==null&&clearTimeout(this.cache.ttl),this.cache.ttl=setTimeout(()=>this.setHasCache(!1),t))}}getValue(){return this.storeValue}setError(i){i!==this._value().error&&(R()&&Y(`Set Error`),this._setState(e=>s$2(r$1({},e),{error:i})))}_select(i){return this.store.asObservable().pipe(Ve$3(e=>i(e.state)),ld())}_value(){return this.storeValue}_cache(){return this.cache.active}get config(){return this.constructor[gt]||{}}get storeName(){return this.config.storeName||this.options.storeName||this.options.name}get deepFreeze(){return this.config.deepFreezeFn||this.options.deepFreezeFn||ln}get cacheConfig(){return this.config.cache||this.options.cache}get _producerFn(){return this.config.producerFn||this.options.producerFn||va()}get resettable(){return nt(this.config.resettable)?this.config.resettable:this.options.resettable}_setState(i,e=!0){if(w(i)){let t=i(this._value());this.storeValue=qt?this.deepFreeze(t):t}else this.storeValue=i;if(!this.store){this.store=new nr$2({state:this.storeValue}),R()&&this.store.subscribe(({action:t})=>{t&&ka(this.storeName,t)});return}if(pi()){this.handleTransaction();return}this.dispatch(this.storeValue,e)}reset(){this.isResettable()&&(R()&&Y(`Reset`),this._setState(()=>Object.assign({},this._initialState)),this.setHasCache(!1))}update(i){R()&&Y(`Update`);let e,t=this._value();w(i)?e=w(this._producerFn)?this._producerFn(t,i):i(t):e=i;let r=this.akitaPreUpdate(t,r$1(r$1({},t),e)),a=It(t)?r:new t.constructor(r);this._setState(a)}updateStoreConfig(i){this.options=r$1(r$1({},this.options),i)}akitaPreUpdate(i,e){return e}destroy(){!(ft&&window.hmrEnabled)&&this===F[this.storeName]&&(delete F[this.storeName],xa(this.storeName),this.setHasCache(!1),this.cache.active.complete(),this.store.complete())}onInit(i){F[this.storeName]=this,this._setState(()=>i),wa(this.storeName),this.isResettable()&&(this._initialState=i),R()&&Aa(this.storeName,this.constructor.name)}dispatch(i,e=!0){let t;e&&(t=ht,Gi()),this.store.next({state:i,action:t})}watchTransaction(){dn().subscribe(()=>{this.inTransaction=!1,this.dispatch(this._value())})}isResettable(){return this.resettable===!1?!1:this.resettable||Mt().resettable}handleTransaction(){this.inTransaction||(this.watchTransaction(),this.inTransaction=!0)}getCacheTTL(){return this.cacheConfig&&this.cacheConfig.ttl||Mt().ttl}};function mn({state:n,ids:i,idKey:e,newStateOrFn:t$1,preUpdateEntity:r,producerFn:a,onEntityIdChanges:o}){let l={},u=!1,f;for(let C of i){if(Me(n.entities,C)===!1)continue;let B=n.entities[C],te;w(t$1)?te=w(a)?a(B,t$1):t$1(B):te=t$1;let he=te.hasOwnProperty(e)&&te[e]!==B[e],ge;f=C,he&&(u=!0,f=te[e]);let ie=r$1(r$1({},B),te);It(B)?ge=ie:It(te)?ge=new B.constructor(ie):ge=new te.constructor(ie),l[f]=r(B,ge)}let q=n.ids,P=n.entities;if(u){let[C]=i,A=n.entities,{[C]:B}=A;P=u$4(A,[t(C)]),q=n.ids.map(he=>he===C?f:he),o(C,f)}return s$2(r$1({},n),{entities:r$1(r$1({},P),l),ids:q})}var Da;var _t=class n extends at{constructor(i={},e={}){super(r$1(r$1({},rn()),i),e),this.options=e,this.entityActions=new ne$2,this.entityIdChanges=new ne$2}get selectEntityAction$(){return this.entityActions.asObservable()}get selectEntityIdChanges$(){return this.entityIdChanges.asObservable()}get idKey(){return this.config.idKey||this.options.idKey||`id`}set(i,e={}){if(Z(i))return;R()&&Y(`Set Entity`);let t=this.akitaPreAddEntity===n.prototype.akitaPreAddEntity;this.setHasCache(!0,{restartTTL:!0}),this._setState(r=>{let a=sn({state:r,entities:i,idKey:this.idKey,preAddEntity:this.akitaPreAddEntity.bind(this),isNativePreAdd:t});return Se(e.activeId)===!1&&(a.active=e.activeId),a}),this.hasInitialUIState()&&this.handleUICreation(),this.entityActions.next({type:rt.Set,ids:this.ids})}add(i,e={loading:!1}){let t=Q(i);if(Te(t))return;let r=Ki({state:this._value(),preAddEntity:this.akitaPreAddEntity.bind(this),entities:t,idKey:this.idKey,options:e});r&&(R()&&Y(`Add Entity`),r.newState.loading=e.loading,this._setState(()=>r.newState),this.hasInitialUIState()&&this.handleUICreation(!0),this.entityActions.next({type:rt.Add,ids:r.newIds}))}update(i,e){if(Se(e)){super.update(i);return}let t=[];if(w(i)?t=this.ids.filter(a=>i(this.entities[a])):t=Z(i)?this.ids:Q(i),Te(t))return;R()&&Y(`Update Entity`,t);let r;this._setState(a=>mn({idKey:this.idKey,ids:t,preUpdateEntity:this.akitaPreUpdateEntity.bind(this),state:a,newStateOrFn:e,producerFn:this._producerFn,onEntityIdChanges:(o,l)=>{r={oldId:o,newId:l},this.entityIdChanges.next(s$2(r$1({},r),{pending:!0}))}})),r&&this.entityIdChanges.next(s$2(r$1({},r),{pending:!1})),this.entityActions.next({type:rt.Update,ids:t})}upsert(i,e,t,r={}){let a=Q(i),o=P=>A=>Me(this.entities,A)===P,l=w(t)?r.baseClass:t?t.baseClass:void 0,u=w(l),f=a.filter(o(!0)),q=a.filter(o(!1)).map(P=>{let A=typeof e==`function`?e({}):e,B=s$2(r$1({},w(t)?t(P,A):A),{[this.idKey]:P});return u?new l(B):B});this.update(f,e),this.add(q),R()&&me(`Upsert Entity`)}upsertMany(i,e={}){let t=[],r=[],a={};for(let o of i){let l=this.akitaPreCheckEntity(o),u=l[this.idKey];if(Me(this.entities,u)){let f=this._value().entities[u],q=r$1(r$1({},this._value().entities[u]),l),P=e.baseClass?new e.baseClass(q):q,A=this.akitaPreUpdateEntity(f,P),C=A[this.idKey];a[C]=A,r.push(C)}else{let f=e.baseClass?new e.baseClass(l):l,q=this.akitaPreAddEntity(f),P=q[this.idKey];t.push(P),a[P]=q}}R()&&me(`Upsert Many`),this._setState(o=>s$2(r$1({},o),{ids:t.length?[...o.ids,...t]:o.ids,entities:r$1(r$1({},o.entities),a),loading:!!e.loading})),r.length&&this.entityActions.next({type:rt.Update,ids:r}),t.length&&this.entityActions.next({type:rt.Add,ids:t}),t.length&&this.hasUIStore()&&this.handleUICreation(!0)}replace(i,e){let t=Q(i);if(Te(t))return;let r={};for(let a of t)r[a]=s$2(r$1({},e),{[this.idKey]:a});R()&&Y(`Replace Entity`,i),this._setState(a=>s$2(r$1({},a),{entities:r$1(r$1({},a.entities),r)}))}move(i,e){let t=this.ids.slice();t.splice(e<0?t.length+e:e,0,t.splice(i,1)[0]),R()&&Y(`Move Entity`),this._setState(r=>s$2(r$1({},r),{entities:r$1({},r.entities),ids:t}))}remove(i){if(Te(this.ids))return;let e=nt(i),t=[];w(i)?t=this.ids.filter(r=>i(this.entities[r])):t=e?Q(i):this.ids,!Te(t)&&(R()&&Y(`Remove Entity`,t),this._setState(r=>an({state:r,ids:t})),e||this.setHasCache(!1),this.handleUIRemove(t),this.entityActions.next({type:rt.Remove,ids:t}))}updateActive(i){let e=Q(this.active);R()&&Y(`Update Active`,e),this.update(e,i)}setActive(i){let e=nn(i,this.ids,this.active);e!==void 0&&(R()&&Y(`Set Active`,e),this._setActive(e))}addActive(i){let e=Q(i);Te(e)||e.every(r=>this.active.indexOf(r)>-1)||(R()&&Y(`Add Active`,i),this._setState(r=>{let a=Array.from(new Set([...r.active,...e]));return s$2(r$1({},r),{active:a})}))}removeActive(i){let e=Q(i);Te(e)||!e.some(r=>this.active.indexOf(r)>-1)||(R()&&Y(`Remove Active`,i),this._setState(r=>s$2(r$1({},r),{active:Array.isArray(r.active)?r.active.filter(a=>e.indexOf(a)===-1):null})))}toggleActive(i){let e=Q(i),t=o=>l=>this.active.includes(l)===o,r=e.filter(t(!0)),a=e.filter(t(!1));this.removeActive(r),this.addActive(a),R()&&me(`Toggle Active`)}createUIStore(i={},e={}){let t={name:`UI/${this.storeName}`,idKey:this.idKey};return this.ui=new Gt(i,r$1(r$1({},t),e)),this.ui}destroy(){super.destroy(),this.ui instanceof n&&this.ui.destroy(),this.entityActions.complete()}akitaPreUpdateEntity(i,e){return e}akitaPreAddEntity(i){return i}akitaPreCheckEntity(i){return i}get ids(){return this._value().ids}get entities(){return this._value().entities}get active(){return this._value().active}_setActive(i){this._setState(e=>s$2(r$1({},e),{active:i}))}handleUICreation(i=!1){let e=this.ids,t=w(this.ui._akitaCreateEntityFn),r,a=o=>{let l=this.entities[o],u=t?this.ui._akitaCreateEntityFn(l):this.ui._akitaCreateEntityFn;return r$1({[this.idKey]:l[this.idKey]},u)};i?r=this.ids.filter(o=>Se(this.ui.entities[o])).map(a):r=e.map(a),i?this.ui.add(r):this.ui.set(r)}hasInitialUIState(){return this.hasUIStore()&&Se(this.ui._akitaCreateEntityFn)===!1}handleUIRemove(i){this.hasUIStore()&&this.ui.remove(i)}hasUIStore(){return this.ui instanceof Gt}};AM([ui(),OM(`design:type`,Function),OM(`design:paramtypes`,[Object,Object,Object,Object]),OM(`design:returntype`,void 0)],_t.prototype,`upsert`,null);AM([ui(),OM(`design:type`,Function),OM(`design:paramtypes`,[typeof(Da=typeof T<`u`&&T)==`function`?Da:Object]),OM(`design:returntype`,void 0)],_t.prototype,`toggleActive`,null);var Gt=class extends _t{constructor(i={},e={}){super(i,e)}setInitialEntityState(i){this._akitaCreateEntityFn=i}};function hn(){return bn$3(n=>n!=null)}function Pa(n){return function(i,e){let t=w(n[0]);return n.some(r=>t?r(i)!==r(e):i[r]!==e[r])===!1}}function bt(n){return typeof n==`string`}var pn=`akitaQueryConfig`;var yt=class{constructor(i){this.store=i,this.__store__=i,R()&&(Xi[i.storeName]=this)}select(i){let e;if(w(i))e=i;else if(bt(i))e=t=>t[i];else{if(Array.isArray(i))return this.store._select(t=>t).pipe(ld(Pa(i)),Ve$3(t=>w(i[0])?i.map(r=>r(t)):i.reduce((r,a)=>(r[a]=t[a],r),{})));e=t=>t}return this.store._select(e)}selectLoading(){return this.select(i=>i.loading)}selectError(){return this.select(i=>i.error)}getValue(){return this.store._value()}selectHasCache(){return this.store._cache().asObservable()}getHasCache(){return this.store._cache().value}get config(){return this.constructor[pn]}};function vt(n,i){return i.split(`.`).length===1?n:i.split(`.`).slice(1).join(`.`).split(`.`).reduce((t,r)=>t&&t[r],n)}function Dt(n,i,e,t=!1){let r=i.split(`.`);if(r.length===1)return r$1(r$1({},n),e);n=r$1({},n);let a=r.length-2;return i.split(`.`).slice(1).reduce((l,u,f)=>f!==a?(l[u]=r$1({},l[u]),l&&l[u]):(l[u]=t||Array.isArray(l[u])||!Ie(l[u])?e:r$1(r$1({},l[u]),e),l&&l[u]),n),n}var La=!1;var ko=new or$2(1);function un(n){La=n}function So(){return La}function Co(n){return n&&w(n.then)}function $t(n){return Co(n)||my(n)?je$1(n):hy(n)}function fn(n){let i={key:`AkitaStores`,enableInNonBrowser:!1,storage:Zi()?localStorage:n.storage,deserialize:JSON.parse,serialize:JSON.stringify,include:[],select:[],persistOnDestroy:!1,preStorageUpdate:function(N,k){return k},preStoreUpdate:function(N,k){return k},skipStorageUpdate:So,preStorageUpdateOperator:()=>N=>N},{storage:e,enableInNonBrowser:t,deserialize:r,serialize:a,include:o,select:l,key:u,preStorageUpdate:f,persistOnDestroy:q,preStorageUpdateOperator:P,preStoreUpdate:A,skipStorageUpdate:C}=Object.assign({},i,n);if(Ht&&!t||!e)return;let B=o.length>0,te=l.length>0,he,ge;B&&(he=o.reduce((N,k)=>{if(w(k))N.fns.push(k);else{let De=k.split(`.`)[0];N[De]=k}return N},{fns:[]})),te&&(ge=l.reduce((N,k)=>(N[k.storeName]=k,N),{}));let ie={},Lt={},xt=[],wt=[];function Ft(N){$t(N).subscribe(()=>{let k=wt.shift();k&&Ft(k)})}let uo=Zi()&&e===localStorage||Sa()&&e===sessionStorage;return $t(e.getItem(u)).subscribe(N=>{let k=Ie(N)?N:r(N||`{}`);function De(y){k.$cache=r$1(r$1({},k.$cache||{}),y),k=Object.assign({},k,Lt),wt.push(e.setItem(u,uo?a(k):k)),Ft(wt.shift())}function kt(y,St){ie[y]=F[y]._select(le=>vt(le,St)).pipe(pd(1),Ve$3(le=>te&&ge[y]?ge[y](le):le),bn$3(()=>C()===!1),P()).subscribe(le=>{Lt[y]=f(y,le),Promise.resolve().then(()=>De({[y]:F[y]._cache().getValue()}))})}function Mi(y,St,le){if(y in k){Y(`@PersistState`),St._setState(Xt=>Dt(Xt,le,A(y,k[y],Xt)));let An=k.$cache?k.$cache[y]:!1;F[y].setHasCache(An,{restartTTL:!0})}}xt.push(jt.subscribe(y=>{ie[y]&&(q===!1&&De({[y]:!1}),ie[y].unsubscribe(),delete ie[y])})),xt.push(ut.subscribe(y=>{if(y===`router`)return;let St=F[y];if(B){let le=he[y];if(!le)if(he.fns.some(Xt=>Xt(y)))le=y;else return;Mi(y,St,le),kt(y,le)}else Mi(y,St,y),kt(y,y)})),ko.next(!0)}),{destroy(){xt.forEach(N=>N.unsubscribe());for(let N=0,k=Object.keys(ie);N<k.length;N++){let De=k[N];ie[De].unsubscribe()}ie={}},clear(){e.clear()},clearStore(N){if(Z(N)){$t(e.setItem(u,`{}`)).subscribe();return}$t(e.getItem(u)).subscribe(De=>{let kt=r(De||`{}`);kt[N]&&(delete kt[N],$t(e.setItem(u,a(kt))).subscribe())})}}}var ot=class{constructor(i,e){this.query=i,e&&e.resetFn&&Mt().resettable&&this.onReset(e.resetFn)}getQuery(){return this.query}getStore(){return this.getQuery().__store__}isEntityBased(i){return qe(i)}selectSource(i,e){return this.isEntityBased(i)?this.getQuery().selectEntity(i).pipe(hn()):e?this.getQuery().select(t=>vt(t,this.withStoreName(e))):this.getQuery().select()}getSource(i,e){if(this.isEntityBased(i))return this.getQuery().getEntity(i);let t=this.getQuery().getValue();return e?vt(t,this.withStoreName(e)):t}withStoreName(i){return`${this.storeName}.${i}`}get storeName(){return this.getStore().storeName}updateStore(i,e,t,r=!1){if(this.isEntityBased(e)){let a=this.getStore();r?a.replace(e,i):a.update(e,i)}else{if(t){this.getStore()._setState(o=>Dt(o,this.withStoreName(t),i,!0));return}let a=r?i:o=>r$1(r$1({},o),i);this.getStore()._setState(a)}}onReset(i){let e=this.getStore().reset;this.getStore().reset=(...t)=>{setTimeout(()=>{e.apply(this.getStore(),t),i()})}}};var Mo={pagesControls:!1,range:!1,startWith:1,cacheTimeout:void 0,clearStoreWithCache:!0};var fi=class extends ot{constructor(i,e={}){super(i,{resetFn:()=>{this.initial=!1,this.destroy({clearCache:!0,currentPage:1})}}),this.query=i,this.config=e,this.metadata=new Map,this.pages=new Map,this.pagination={currentPage:1,perPage:0,total:0,lastPage:0,data:[]},this.initial=!0,this.isLoading$=this.query.selectLoading().pipe(cd(0)),this.config=r$1(r$1({},Mo),e);let{startWith:t,cacheTimeout:r}=this.config;this.page=new nr$2(t),my(r)&&(this.clearCacheSubscription=r.subscribe(()=>this.clearCache()))}get pageChanges(){return this.page.asObservable()}get currentPage(){return this.pagination.currentPage}get isFirst(){return this.currentPage===1}get isLast(){return this.currentPage===this.pagination.lastPage}withControls(){return this.config.pagesControls=!0,this}withRange(){return this.config.range=!0,this}setLoading(i=!0){this.getStore().setLoading(i)}update(i){this.pagination=i,this.addPage(i.data)}addPage(i){this.pages.set(this.currentPage,{ids:i.map(e=>e[this.getStore().idKey])}),this.getStore().upsertMany(i)}clearCache(i={}){this.initial||(me(`@Pagination - Clear Cache`),i.clearStore!==!1&&(this.config.clearStoreWithCache||i.clearStore)&&this.getStore().remove(),this.pages=new Map,this.metadata=new Map),this.initial=!1}clearPage(i){this.pages.delete(i)}destroy({clearCache:i,currentPage:e}={}){this.clearCacheSubscription&&this.clearCacheSubscription.unsubscribe(),i&&this.clearCache(),Se(e)||this.setPage(e),this.initial=!0}isPageActive(i){return this.currentPage===i}setPage(i){(i!==this.currentPage||!this.hasPage(i))&&this.page.next(this.pagination.currentPage=i)}nextPage(){this.currentPage!==this.pagination.lastPage&&this.setPage(this.pagination.currentPage+1)}prevPage(){this.pagination.currentPage>1&&this.setPage(this.pagination.currentPage-1)}setLastPage(){this.setPage(this.pagination.lastPage)}setFirstPage(){this.setPage(1)}hasPage(i){return this.pages.has(i)}getPage(i){let e=this.pagination.currentPage;return this.hasPage(e)?this.selectPage(e):(this.setLoading(!0),je$1(i()).pipe(Xu(t=>(e=t.currentPage,Qt(()=>{this.setLoading(!1),this.update(t)}),this.selectPage(e)))))}getQuery(){return this.query}refreshCurrentPage(){Z(this.currentPage)===!1&&(this.clearPage(this.currentPage),this.setPage(this.currentPage))}getFrom(){return this.isFirst?1:(this.currentPage-1)*this.pagination.perPage+1}getTo(){return this.isLast?this.pagination.total:this.currentPage*this.pagination.perPage}selectPage(i){return this.query.selectAll({asObject:!0}).pipe(Lt$4(1),Ve$3(e=>{let t=s$2(r$1({},this.pagination),{data:this.pages.get(i).ids.map(o=>e[o])}),{range:r,pagesControls:a}=this.config;return isNaN(this.pagination.total)&&(t.lastPage===1?t.total=t.data?t.data.length:0:t.total=t.perPage*t.lastPage,this.pagination.total=t.total),r&&(t.from=this.getFrom(),t.to=this.getTo()),a&&(t.pageControls=To(this.pagination.total,this.pagination.perPage)),t}))}};AM([Wi(`@Pagination - New Page`),OM(`design:type`,Function),OM(`design:paramtypes`,[Object]),OM(`design:returntype`,void 0)],fi.prototype,`update`,null);function To(n,i){let e=Math.ceil(n/i),t=[];for(let r=0;r<e;r++)t.push(r+1);return t}var gn=(function(n){return n.Update=`UPDATE`,n})(gn||{});gn.Update;var Ge=(function(n){return n.Update=`UPDATE`,n.AddEntities=`ADD_ENTITIES`,n.SetEntities=`SET_ENTITIES`,n.UpdateEntities=`UPDATE_ENTITIES`,n.RemoveEntities=`REMOVE_ENTITIES`,n.UpsertEntities=`UPSERT_ENTITIES`,n.UpsertManyEntities=`UPSERT_MANY_ENTITIES`,n})(Ge||{});Ge.Update,Ge.AddEntities,Ge.SetEntities,Ge.UpdateEntities,Ge.RemoveEntities,Ge.UpsertEntities,Ge.UpsertManyEntities;var gi=class{getStoresSnapshot(i=[]){let e={},r=i.length>0?i:Object.keys(F);for(let a=0;a<r.length;a++){let o=r[a];o!==`router`&&(e[o]=F[o]._value())}return e}setStoresSnapshot(i,e){let t=r$1({skipStorageUpdate:!1,lazy:!1},e);t.skipStorageUpdate&&un(!0);let r=i;bt(i)&&(r=JSON.parse(r));let a=Object.keys(r).length;if(t.lazy)ut.pipe(bn$3(o=>r.hasOwnProperty(o)),Lt$4(a)).subscribe(o=>F[o]._setState(()=>r[o]));else for(let o=0,l=Object.keys(r);o<l.length;o++){let u=l[o];F[u]&&F[u]._setState(()=>r[u])}t.skipStorageUpdate&&un(!1)}};new gi;var Ra=(()=>{class n{_animationsDisabled=z$4();state=`unchecked`;disabled=!1;appearance=`full`;static ɵfac=function(t){return new(t||n)};static ɵcmp=YC({type:n,selectors:[[`mat-pseudo-checkbox`]],hostAttrs:[1,`mat-pseudo-checkbox`],hostVars:12,hostBindings:function(t,r){t&2&&Qm(`mat-pseudo-checkbox-indeterminate`,r.state===`indeterminate`)(`mat-pseudo-checkbox-checked`,r.state===`checked`)(`mat-pseudo-checkbox-disabled`,r.disabled)(`mat-pseudo-checkbox-minimal`,r.appearance===`minimal`)(`mat-pseudo-checkbox-full`,r.appearance===`full`)(`_mat-animation-noopable`,r._animationsDisabled)},inputs:{state:`state`,disabled:`disabled`,appearance:`appearance`},decls:0,vars:0,template:function(t,r){},styles:[`.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
  display: inline-block;
  vertical-align: middle;
...
`;var Hs=[`unscopedContent`];var qs=[`text`];var Qs=[[[``,`matListItemAvatar`,``],[``,`matListItemIcon`,``]],[[``,`matListItemTitle`,``]],[[``,`matListItemLine`,``]],`*`,[[``,`matListItemMeta`,``]],[[`mat-divider`]]];var Gs=[`[matListItemAvatar],[matListItemIcon]`,`[matListItemTitle]`,`[matListItemLine]`,`*`,`[matListItemMeta]`,`mat-divider`];var $s=new S$2(`ListOption`);var Ws=(()=>{class n{_elementRef=y$3(Jr$1);static ɵfac=function(t){return new(t||n)};static ɵdir=ew({type:n,selectors:[[``,`matListItemTitle`,``]],hostAttrs:[1,`mat-mdc-list-item-title`,`mdc-list-item__primary-text`]})}return n})();var Ks=(()=>{class n{_elementRef=y$3(Jr$1);static ɵfac=function(t){return new(t||n)};static ɵdir=ew({type:n,selectors:[[``,`matListItemLine`,``]],hostAttrs:[1,`mat-mdc-list-item-line`,`mdc-list-item__secondary-text`]})}return n})();var Ys=(()=>{class n{static ɵfac=function(t){return new(t||n)};static ɵdir=ew({type:n,selectors:[[``,`matListItemMeta`,``]],hostAttrs:[1,`mat-mdc-list-item-meta`,`mdc-list-item__end`]})}return n})();var no=(()=>{class n{_listOption=y$3($s,{optional:!0});_isAlignedAtStart(){return!this._listOption||this._listOption?._getTogglePosition()===`after`}static ɵfac=function(t){return new(t||n)};static ɵdir=ew({type:n,hostVars:4,hostBindings:function(t,r){t&2&&Qm(`mdc-list-item__start`,r._isAlignedAtStart())(`mdc-list-item__end`,!r._isAlignedAtStart())}})}return n})();var Zs=(()=>{class n extends no{static ɵfac=(()=>{let e;return function(r){return(e||(e=uI(n)))(r||n)}})();static ɵdir=ew({type:n,selectors:[[``,`matListItemAvatar`,``]],hostAttrs:[1,`mat-mdc-list-item-avatar`],features:[gm]})}return n})();var Xs=(()=>{class n extends no{static ɵfac=(()=>{let e;return function(r){return(e||(e=uI(n)))(r||n)}})();static ɵdir=ew({type:n,selectors:[[``,`matListItemIcon`,``]],hostAttrs:[1,`mat-mdc-list-item-icon`],features:[gm]})}return n})();var Js=new S$2(`MAT_LIST_CONFIG`);var En=(()=>{class n{_isNonInteractive=!0;get disableRipple(){return this._disableRipple}set disableRipple(e){this._disableRipple=vi$3(e)}_disableRipple=!1;get disabled(){return this._disabled()}set disabled(e){this._disabled.set(vi$3(e))}_disabled=ze$1(!1);_defaultOptions=y$3(Js,{optional:!0});static ɵfac=function(t){return new(t||n)};static ɵdir=ew({type:n,hostVars:1,hostBindings:function(t,r){t&2&&Sm(`aria-disabled`,r.disabled)},inputs:{disableRipple:`disableRipple`,disabled:`disabled`}})}return n})();var el=(()=>{class n{_elementRef=y$3(Jr$1);_ngZone=y$3(Ce$1);_listBase=y$3(En,{optional:!0});_platform=y$3(p$1);_hostElement;_isButtonElement;_noopAnimations=z$4();_avatars;_icons;set lines(e){this._explicitLines=Mt$3(e,null),this._updateItemLines(!1)}_explicitLines=null;get disableRipple(){return this.disabled||this._disableRipple||this._noopAnimations||!!this._listBase?.disableRipple}set disableRipple(e){this._disableRipple=vi$3(e)}_disableRipple=!1;get disabled(){return this._disabled()||!!this._listBase?.disabled}set disabled(e){this._disabled.set(vi$3(e))}_disabled=ze$1(!1);_subscriptions=new J$3;_rippleRenderer=null;_hasUnscopedTextContent=!1;rippleConfig;get rippleDisabled(){return this.disableRipple||!!this.rippleConfig.disabled}constructor(){y$3(I$5).load(Ye$1);let e=y$3(Ut$3,{optional:!0});this.rippleConfig=e||{},this._hostElement=this._elementRef.nativeElement,this._isButtonElement=this._hostElement.nodeName.toLowerCase()===`button`,this._listBase&&!this._listBase._isNonInteractive&&this._initInteractiveListItem(),this._isButtonElement&&!this._hostElement.hasAttribute(`type`)&&this._hostElement.setAttribute(`type`,`button`)}ngAfterViewInit(){this._monitorProjectedLinesAndTitle(),this._updateItemLines(!0)}ngOnDestroy(){this._subscriptions.unsubscribe(),this._rippleRenderer!==null&&this._rippleRenderer._removeTriggerEvents()}_hasIconOrAvatar(){return!!(this._avatars.length||this._icons.length)}_initInteractiveListItem(){this._hostElement.classList.add(`mat-mdc-list-item-interactive`),this._rippleRenderer=new X$4(this,this._ngZone,this._hostElement,this._platform,y$3(ve$1)),this._rippleRenderer.setupTriggerEvents(this._hostElement)}_monitorProjectedLinesAndTitle(){this._ngZone.runOutsideAngular(()=>{this._subscriptions.add(Oy(this._lines.changes,this._titles.changes).subscribe(()=>this._updateItemLines(!1)))})}_updateItemLines(e){if(!this._lines||!this._titles||!this._unscopedContent)return;e&&this._checkDomForUnscopedTextContent();let t=this._explicitLines??this._inferLinesFromContent(),r=this._unscopedContent.nativeElement;if(this._hostElement.classList.toggle(`mat-mdc-list-item-single-line`,t<=1),this._hostElement.classList.toggle(`mdc-list-item--with-one-line`,t<=1),this._hostElement.classList.toggle(`mdc-list-item--with-two-lines`,t===2),this._hostElement.classList.toggle(`mdc-list-item--with-three-lines`,t===3),this._hasUnscopedTextContent){let a=this._titles.length===0&&t===1;r.classList.toggle(`mdc-list-item__primary-text`,a),r.classList.toggle(`mdc-list-item__secondary-text`,!a)}else r.classList.remove(`mdc-list-item__primary-text`),r.classList.remove(`mdc-list-item__secondary-text`)}_inferLinesFromContent(){let e=this._titles.length+this._lines.length;return this._hasUnscopedTextContent&&(e+=1),e}_checkDomForUnscopedTextContent(){this._hasUnscopedTextContent=Array.from(this._unscopedContent.nativeElement.childNodes).filter(e=>e.nodeType!==e.COMMENT_NODE).some(e=>!!(e.textContent&&e.textContent.trim()))}static ɵfac=function(t){return new(t||n)};static ɵdir=ew({type:n,contentQueries:function(t,r,a){if(t&1&&Bm(a,Zs,4)(a,Xs,4),t&2){let o;vb(o=yb())&&(r._avatars=o),vb(o=yb())&&(r._icons=o)}},hostVars:4,hostBindings:function(t,r){t&2&&(Sm(`aria-disabled`,r.disabled)(`disabled`,r._isButtonElement&&r.disabled||null),Qm(`mdc-list-item--disabled`,r.disabled))},inputs:{lines:`lines`,disableRipple:`disableRipple`,disabled:`disabled`}})}return n})();var ro=(()=>{class n extends En{static ɵfac=(()=>{let e;return function(r){return(e||(e=uI(n)))(r||n)}})();static ɵcmp=YC({type:n,selectors:[[`mat-list`]],hostAttrs:[1,`mat-mdc-list`,`mat-mdc-list-base`,`mdc-list`],exportAs:[`matList`],features:[e_([{provide:En,useExisting:n}]),gm],ngContentSelectors:Us,decls:1,vars:0,template:function(t,r){t&1&&(hb(),gb(0))},styles:[js],encapsulation:2})}return n})();var ao=(()=>{class n extends el{_lines;_titles;_meta;_unscopedContent;_itemText;get activated(){return this._activated}set activated(e){this._activated=vi$3(e)}_activated=!1;_getAriaCurrent(){return this._hostElement.nodeName===`A`&&this._activated?`page`:null}_hasBothLeadingAndTrailing(){return this._meta.length!==0&&(this._avatars.length!==0||this._icons.length!==0)}static ɵfac=(()=>{let e;return function(r){return(e||(e=uI(n)))(r||n)}})();static ɵcmp=YC({type:n,selectors:[[`mat-list-item`],[`a`,`mat-list-item`,``],[`button`,`mat-list-item`,``]],contentQueries:function(t,r,a){if(t&1&&Bm(a,Ks,5)(a,Ws,5)(a,Ys,5),t&2){let o;vb(o=yb())&&(r._lines=o),vb(o=yb())&&(r._titles=o),vb(o=yb())&&(r._meta=o)}},viewQuery:function(t,r){if(t&1&&Um(Hs,5)(qs,5),t&2){let a;vb(a=yb())&&(r._unscopedContent=a.first),vb(a=yb())&&(r._itemText=a.first)}},hostAttrs:[1,`mat-mdc-list-item`,`mdc-list-item`],hostVars:13,hostBindings:function(t,r){t&2&&(Sm(`aria-current`,r._getAriaCurrent()),Qm(`mdc-list-item--activated`,r.activated)(`mdc-list-item--with-leading-avatar`,r._avatars.length!==0)(`mdc-list-item--with-leading-icon`,r._icons.length!==0)(`mdc-list-item--with-trailing-meta`,r._meta.length!==0)(`mat-mdc-list-item-both-leading-and-trailing`,r._hasBothLeadingAndTrailing())(`_mat-animation-noopable`,r._noopAnimations))},inputs:{activated:`activated`},exportAs:[`matListItem`],features:[gm],ngContentSelectors:Gs,decls:10,vars:0,consts:[[`unscopedContent`,``],[1,`mdc-list-item__content`],[1,`mat-mdc-list-item-unscoped-content`,3,`cdkObserveContent`],[1,`mat-focus-indicator`]],template:function(t,r){t&1&&(hb(Qs),gb(0),as$2(1,`span`,1),gb(2,1),gb(3,2),as$2(4,`span`,2,0),jm(`cdkObserveContent`,function(){return r._updateItemLines(!0)}),gb(6,3),ou()(),gb(7,4),gb(8,5),xm(9,`div`,3))},dependencies:[Za$1],encapsulation:2})}return n})();var oo=(()=>{class n{constructor(){this.lang=y$3(G)}static{this.ɵfac=function(t){return new(t||n)}}static{this.ɵcmp=YC({type:n,selectors:[[`app-not-found`]],decls:23,vars:19,consts:[[1,`container`,`center`],[1,`catalog-heading`],[`role`,`list`],[`mat-button`,``,`color`,`primary`,3,`routerLink`]],template:function(t,r){t&1&&(as$2(0,`div`,0)(1,`h2`,1),Ub(2),a_(3,`translate`),ou(),as$2(4,`p`),Ub(5),a_(6,`translate`),ou(),as$2(7,`mat-list`,2)(8,`mat-list-item`)(9,`a`,3),Ub(10),a_(11,`translate`),ou()(),as$2(12,`mat-list-item`)(13,`a`,3),Ub(14),a_(15,`translate`),ou()(),as$2(16,`mat-list-item`)(17,`a`,3),Ub(18,`CV`),ou()(),as$2(19,`mat-list-item`)(20,`a`,3),Ub(21),a_(22,`translate`),ou()()()()),t&2&&(cT(2),nv(l_(3,9,`notFound.title`)),cT(3),nv(l_(6,11,`notFound.message`)),cT(4),Nm(`routerLink`,r.lang.link(`artworks`)),cT(),uu(` `,l_(11,13,`paintings`),` `),cT(3),Nm(`routerLink`,r.lang.link(`about`)),cT(),uu(` `,l_(15,15,`statement.title`),` `),cT(3),Nm(`routerLink`,r.lang.link(`cv`)),cT(3),Nm(`routerLink`,r.lang.link(`contact`)),cT(),uu(` `,l_(22,17,`menu.contact`),` `))},dependencies:[ro,ao,ar$2,_t$1,$t$2],styles:[`.center[_ngcontent-%COMP%]{text-align:center}`]})}}return n})();var Zt=()=>y$3(N$2).isAdmin()||y$3(ee).parseUrl(`/door`);var so=()=>(y$3(H$1).use(n.SPANISH),!0);var lo=(n$4,i)=>il()?y$3(ee).parseUrl(`/es${tl(i.url)}`):(y$3(H$1).use(n.ENGLISH),!0);function tl(n){return n.replace(/^\/(?=$|[?#])/,``)}var Ot=()=>(y$3(H$1).use(co()),!0);function il(){return typeof window>`u`?!1:co()===n.SPANISH}function co(){return typeof window>`u`?n.ENGLISH:L()??N()}var mo=[{path:``,pathMatch:`full`,loadComponent:()=>import(`./chunk-C1rZWTCv.js`).then(n=>n.HomeComponent),data:{description:`seo.default.description`,hideBreadcrumb:!0}},{path:`artworks`,loadComponent:()=>import(`./chunk-Bm2O-5Zu.js`).then(n=>n.ArtPiecesListComponent),title:`seo.paintings.title`,data:{breadcrumb:`Paintings`,description:`seo.paintings.description`}},{path:`artwork/:id`,loadComponent:()=>import(`./chunk-C3WwQF4j.js`).then(n=>n.ArtPieceComponent),title:`seo.artwork.title`,data:{description:`seo.paintings.description`,hideBreadcrumb:!0}},{path:`generative/:id`,loadComponent:()=>import(`./chunk-Dmz4Q9yk2.js`).then(n=>n.GenerativePieceComponent),title:`seo.generative.title`,data:{description:`seo.generative.description`,hideBreadcrumb:!0}},{path:`cv`,loadComponent:()=>import(`./chunk-YnNx2sqp.js`).then(n=>n.CvComponent),title:`seo.cv.title`,data:{description:`seo.cv.description`}},{path:`texts`,loadComponent:()=>import(`./chunk-IfL9WZEy.js`).then(n=>n.TextsComponent),title:`seo.texts.title`,data:{description:`seo.texts.description`,hideBreadcrumb:!0}},{path:`about`,loadComponent:()=>import(`./chunk-BRB9cJ2H.js`).then(n=>n.AboutComponent),title:`seo.about.title`,data:{description:`seo.about.description`}},{path:`contact`,loadComponent:()=>import(`./chunk-BRHxp6Ni.js`).then(n=>n.ContactComponent),title:`seo.contact.title`,data:{description:`seo.contact.description`}},{path:`terms`,loadComponent:()=>import(`./chunk-aV6ayuZI.js`).then(n=>n.TermsComponent),title:`seo.terms.title`,data:{description:`seo.terms.description`}},{path:`privacy`,loadComponent:()=>import(`./chunk-BPKvw7fX.js`).then(n=>n.PrivacyComponent),title:`seo.privacy.title`,data:{description:`seo.privacy.description`}}];var po={providers:[jo$1([{path:`es/studio`,redirectTo:`/studio`},{path:`es/door`,redirectTo:`/door`},{path:`es/publish`,redirectTo:`/publish`},{path:`door`,canActivate:[Ot],loadComponent:()=>import(`./chunk-B653WLLe.js`).then(n=>n.DoorComponent),data:{title:`Door`,hideBreadcrumb:!0,noindex:!0}},{path:`studio`,canActivate:[Ot,Zt],loadComponent:()=>import(`./chunk-C6gzzG4F.js`).then(n=>n.StudioComponent),data:{title:`Studio`,hideBreadcrumb:!0,noindex:!0}},{path:`publish`,canActivate:[Ot,Zt],loadComponent:()=>import(`./chunk-CdqVL8Sb2.js`).then(n=>n.PublishComponent),data:{title:`Publish`,hideBreadcrumb:!0,noindex:!0}},{path:`pendingmint`,canActivate:[Ot,Zt],loadComponent:()=>import(`./chunk-iTE5ebK7.js`).then(n=>n.PendingMintComponent),data:{title:`Pending mints`,hideBreadcrumb:!0,noindex:!0}},{path:`es/pendingmint`,redirectTo:`/pendingmint`},{path:`latest`,canActivate:[Ot,Zt],loadComponent:()=>import(`./chunk-CfM8RBAT.js`).then(n=>n.LatestComponent),data:{title:`Latest IG posts`,hideBreadcrumb:!0,noindex:!0}},{path:`es/latest`,redirectTo:`/latest`},{path:`es`,canActivate:[so],children:mo},{path:``,canActivate:[lo],children:mo},{path:`**`,component:oo,title:`seo.notFound.title`}],qo$2(Po$2),Fo$2({skipInitialTransition:!0})),jt$2({fallbackLang:n.ENGLISH}),{provide:n$1,useClass:Ai},p_(),ln$3(cn$3({filter:({url:n})=>![`nfts-snapshot`,`nft-thumbnails`,`critics`,`posts/`,`vision/`].some(i=>n.includes(i))&&!n.endsWith(`/version`)})),Sn$3(Tn$1(),_n$3()),eo(),{provide:pr$1,useExisting:R$2}]};fn({preStorageUpdate:(n,i)=>n===`session`&&!i.lastArtPiecesUpdate?s$2(r$1({},i),{artPieces:[]}):i});e.production?tn():en();Je$1(Ja,po).catch(n=>console.error(n));export{wt$2 as $,ya$1 as A,H$1 as B,ga as C,us$1 as D,ur as E,s as F,N$2 as G,_t$1 as H,u as I,Si$3 as J,e as K,m$1 as L,d$1 as M,f as N,va$1 as O,m as P,lt$4 as Q,R$2 as R,fs$1 as S,re as T,ee as U,W as V,Gt$3 as W,_t$3 as X,V$3 as Y,bi$2 as Z,ae as _,z$2 as _t,$r as a,G$6 as at,ba$1 as b,Hr as c,Qt$3 as ct,Ls$1 as d,Yt$3 as dt,Ot$3 as et,Mn as f,ne$1 as ft,_a as g,tt$4 as gt,Qr as h,te as ht,c$1 as i,$t$3 as it,Et as j,vo as k,Ja$1 as l,U$4 as lt,Ps as m,pt$4 as mt,n$1 as n,Ve$2 as nt,Ca$1 as o,Gt$4 as ot,Nn$1 as p,ni$2 as pt,Di$2 as q,c as r,q$2 as rt,H as s,N$3 as st,G as t,P$1 as tt,Ki$1 as u,Ut$2 as ut,ai as v,gs$1 as w,et as x,as$1 as y,$t$2 as z};