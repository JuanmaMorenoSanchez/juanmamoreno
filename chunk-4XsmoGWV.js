import {Y,$}from'./chunk-BPoqEtrL.js';import {a as at$1,Y as Yo,d as di}from'./chunk-CITtyQ_D.js';import {T,E,C as te,D as Q,G as lt,L as Le,cn as i$1,a1 as SF,co as NF,P as Pe,F as Fe,d as dt,x as c,O as b,aO as p,M as Me,I as IE,cp as sn,cq as at,cr as ki,V as Et$1,e as rt,f as wi,Q as QE,H as Hc,X as Xp,l as QD,h as Hv,Z as ZE,a9 as cD,ao as lD,v as mh,bk as CE,aV as Tr,bM as qe,au as KE,s as sD,aw as JE,o as eh,a$ as S,q as oD,Y as YD,t as sh,g as LD,J as JD,aK as Th,af as qc,cs as Xo,A as Au,R as Ru,n as gh,m as Jp,i as wh,B as Rf}from'./main-64473IBH.js';import'./chunk-DVS8Kg_2.js';var _t=["*"];var xt=new S("MAT_CARD_CONFIG"),gt=(()=>{class i{appearance;constructor(){let t=T(xt,{optional:true});this.appearance=t?.appearance||"raised";}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=IE({type:i,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(e,a){e&2&&mh("mat-mdc-card-outlined",a.appearance==="outlined")("mdc-card--outlined",a.appearance==="outlined")("mat-mdc-card-filled",a.appearance==="filled")("mdc-card--filled",a.appearance==="filled");},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:_t,decls:1,vars:0,template:function(e,a){e&1&&(cD(),lD(0));},styles:[`.mat-mdc-card {
  display: flex;
