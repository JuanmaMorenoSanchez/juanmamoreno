import{Pt as XV,Rr as ve,V as Kr,Xr as y,Yn as me,ht as S$1,ii as ze,kr as tt,mn as en,ni as zC,nn as bt,ti as z}from"./chunk-146AhaIv.js";var s=new WeakMap;var _=(()=>{class e{_appRef;_injector=y(ve);_environmentInjector=y(me);load(n){let t=this._appRef=this._appRef||this._injector.get(bt),i=s.get(t);i||(i={loaders:new Set,refs:[]},s.set(t,i),t.onDestroy(()=>{s.get(t)?.refs.forEach(M=>M.destroy()),s.delete(t)})),i.loaders.has(n)||(i.loaders.add(n),i.refs.push(XV(n,{environmentInjector:this._environmentInjector})))}static ɵfac=function(t){return new(t||e)};static ɵprov=Kr({token:e,factory:e.ɵfac})}return e})();var R=(()=>{class e{static ɵfac=function(t){return new(t||e)};static ɵcmp=zC({type:e,selectors:[[`ng-component`]],exportAs:[`cdkVisuallyHidden`],decls:0,vars:0,template:function(t,i){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
